...
*/
            ...
            executorService.execute(new ThreadsMagic(id,CodeOfProduct,TitleOfProduct,Price,DescriptionOfProduct,previousHash,TimeStamp,0,536870911,lock,prefix,buffer));
            executorService.execute(new ThreadsMagic(id,CodeOfProduct,TitleOfProduct,Price,DescriptionOfProduct,previousHash,TimeStamp,536870912,1073741824,lock,prefix,buffer));
            executorService.execute(new ThreadsMagic(id,CodeOfProduct,TitleOfProduct,Price,DescriptionOfProduct,previousHash,TimeStamp,1073741824,1610612736,lock,prefix,buffer));
            executorService.execute(new ThreadsMagic(id,CodeOfProduct,TitleOfProduct,Price,DescriptionOfProduct,previousHash,TimeStamp,1610612737,2147483647,lock,prefix,buffer));
